...
import com.damonlear.nfctest.nfc.NfcUtil;
import com.damonlear.nfctest.nfc.card.CardManager;

import org.xml.sax.XMLReader;

import java.util.Arrays;

public final class NFCardTest extends Activity implements OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfcard);
    ...
    public Drawable getDrawable(String source) {
        ...
        if (source.startsWith("spliter")) {
            ...
            final float w = NfcUtil.parseInt(params[1], 10, 16) * f + 0.5f;
            final float h = NfcUtil.parseInt(params[2], 10, 16) * f + 0.5f;
