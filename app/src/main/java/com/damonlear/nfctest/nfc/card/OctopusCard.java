...
package com.damonlear.nfctest.nfc.card;

import android.content.res.Resources;
import android.nfc.tech.NfcF;

import com.damonlear.nfctest.R;
import com.damonlear.nfctest.nfc.NfcUtil;
import com.damonlear.nfctest.nfc.tech.FeliCa;
...
final class OctopusCard {
    ...
    static String load(NfcF tech, Resources res) {
        ...
        for (byte i = 0; p < N; ++i) {
            ...
            data[p++] = (NfcUtil.toInt(r.getBlockData(), 0, 4) - 350) / 10.0f;
        }
    ...
    private static String parseBalance(float[] value, int count, Resources res) {
        ...
        for (int i = 0; i < count; ++i)
            r.append(NfcUtil.toAmountString(value[i])).append(' ');
